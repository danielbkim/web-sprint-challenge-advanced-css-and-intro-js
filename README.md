...
1. How would you describe acessibility on the web to someone new to programming?
    > Accessibility is an ideology to help make the web more inclusive for those that are blind, hearing impaired, or speak another language.

2. Talk about 3 different things you can do to ensure your website is accessible.
    > 1. Adding text within the `alt` of an `<img>` tag
    > 2. Making sure you set the language in the `<html>` tag
    > 3. Using semantic `HTML` to make sure that it's readable

3. How would you explain the concept of a variable to someone new to programming?
    > Data is like water, you can't manipulate it or do anything with it until it's placed in a container.  A variable is like a cup, where you can place your water (data) so you're able to do things to it.

4. What is the purpose of using functions in code?
    > To make a certain repeated action reusable and more efficient
